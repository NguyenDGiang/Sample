...
namespace Web.BaseApi
{
    public class BaseApiClient : IBaseApiClient
    {
        ...
        public async Task<List<T>> GetListAsync<T>(string url, string baseApiUrl,
        ...
        public async Task<T> GetAsync<T>(string url, string baseApiUrl, bool requiredLogin = false)
        {
            var client = _httpClientFactory.CreateClient();
            client.BaseAddress = new Uri(baseApiUrl);
            if (requiredLogin)
